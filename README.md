...
**65 §4 constraints · 139 ADRs · 134 active gate rules · 264 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 174 enforcer
rows, and a 654-node / 1269-edge architecture graph — all maintained in
