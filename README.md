...
**65 §4 constraints · 139 ADRs · 142 active gate rules · 270 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 176 enforcer
rows, and a 656-node / 1273-edge architecture graph — all maintained in
