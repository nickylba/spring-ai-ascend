...
**65 §4 constraints · 139 ADRs · 63 active gate rules · 149 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 118 enforcer
rows, and a 584-node / 1157-edge architecture graph — all maintained in
