...
**65 §4 constraints · 139 ADRs · 69 active gate rules · 162 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 124 enforcer
rows, and a 594-node / 1169-edge architecture graph — all maintained in
