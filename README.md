...
**65 §4 constraints · 139 ADRs · 39 active gate rules · 107 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 92 enforcer
rows, and a 556-node / 1105-edge architecture graph — all maintained in
